...
const Privacy = ({ navigation }) => {
    ...
    const get_about = () => {
        ...
        fetch("https://server-php-8-3.technorizen.com/oneTen/api/common/content/privacy-policy", requestOptions)
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#fff" }}>
            ...
            <HeaderTwo back={true} navigation={navigation} title={"Privacy Policy"} />

            <View style={{ height: hp(25), alignItems: 'center', marginTop: 10 }}>
                <Image source={require('../../assets/Cropping/PrivacyPolicy3x.png')}
                    resizeMode='contain'
